#!/usr/bin/env python3
"""
Remote launcher per check_ns8_containers.py
...
REPO_URL = "https://raw.githubusercontent.com/Coverup20/checkmk-tools/main/script-check-ns8/full/check_ns8_containers.py"
...
try:
    ...
    print(f"3 NS8_Containers - Failed to download/execute remote script: {e}")
    sys.exit(0)
