#!/usr/bin/env python3
"""
Remote launcher per check_ssh_root_sessions.py
...
REPO_URL = "https://raw.githubusercontent.com/Coverup20/checkmk-tools/main/script-check-ubuntu/full/check_ssh_root_sessions.py"
...
try:
    ...
    print(f"3 SSH_root_session - Failed to download/execute remote script: {e}")
    sys.exit(0)
