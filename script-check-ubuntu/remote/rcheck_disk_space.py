#!/usr/bin/env python3
"""
Remote launcher per check_disk_space.py
...
REPO_URL = "https://raw.githubusercontent.com/Coverup20/checkmk-tools/main/script-check-ubuntu/full/check_disk_space.py"
...
try:
    ...
    print(f"3 Disk_Space_Root - Failed to download/execute remote script: {e}")
    sys.exit(0)
