#!/usr/bin/env python3
"""
Remote launcher per ydea-toolkit.py
...
REPO_URL = "https://raw.githubusercontent.com/Coverup20/checkmk-tools/main/Ydea-Toolkit/full/ydea-toolkit.py"
...
try:
    ...
    print(f"❌ Failed to download/execute remote script: {e}", file=sys.stderr)
    sys.exit(1)
