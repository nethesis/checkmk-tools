#!/usr/bin/env python3
"""Python wrapper for check_ovpn_host2net.sh - Version: 1.0.0"""

import subprocess
import sys
from pathlib import Path

SERVICE = "OVPN_HostToNet"
LEGACY_SCRIPT = Path("/opt/checkmk-tools/script-check-nsec8/full/check_ovpn_host2net.sh")
