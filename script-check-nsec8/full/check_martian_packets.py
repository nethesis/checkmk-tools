#!/usr/bin/env python3
"""Python wrapper for check_martian_packets.sh - Version: 1.0.0"""

import subprocess
import sys
from pathlib import Path

SERVICE = "Martian_Packets"
LEGACY_SCRIPT = Path("/opt/checkmk-tools/script-check-nsec8/full/check_martian_packets.sh")
