...
# Verifica che lo script repo sia valido (bash o eseguibile generico)            if bash -n "$repo_script" 2>/dev/null || [[ -x "$repo_script" ]]; then                
