...
def usage() -> None:
    print(
        "Usage:\n"
        "  scan-nmap-interattivo-verbose.py [args]\n\n"
        "Delegates to scan-nmap-interattivo-verbose.sh for full workflow."
    )
...
def main() -> int:
    ...
    script = Path(__file__).with_name("scan-nmap-interattivo-verbose.sh")
