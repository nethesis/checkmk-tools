...
def usage() -> None:
    print(
        "Usage:\n"
        "  scan-nmap-interattivo-verbose-multi-options.py [args]\n\n"
        "Delegates to scan-nmap-interattivo-verbose-multi-options.sh for full workflow."
    )
...
def main() -> int:
    ...
    script = Path(__file__).with_name("scan-nmap-interattivo-verbose-multi-options.sh")
