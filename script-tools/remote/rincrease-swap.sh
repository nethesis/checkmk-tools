...
# Verifica se eseguito come rootif [ "$EUID" -ne 0 ]; then    
echo "Questo script deve essere eseguito come root"    exit 1fi
# Scarica in file temporaneo ed esegue con flag --yes
