#!/usr/bin/env python3
"""
Remote launcher for fix_frpc_config.py
...
REPO_URL = "https://raw.githubusercontent.com/Coverup20/checkmk-tools/main/install/Agent-FRPC/full/fix_frpc_config.py"
