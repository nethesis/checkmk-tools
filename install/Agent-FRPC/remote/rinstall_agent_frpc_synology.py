#!/usr/bin/env python3
"""
Remote launcher for install_agent_frpc_synology.py
...
REPO_URL = "https://raw.githubusercontent.com/Coverup20/checkmk-tools/main/install/Agent-FRPC/full/install_agent_frpc_synology.py"
