...
echo ">>> Apache restarted successfully."  else    
echo "ERROR: Apache config invalid, restoring backup..." >&2    mv "$BACKUP_FILE" "$APACHE_CONF" || true    exit 1  fielse  
...
echo ">>> Nginx reloaded successfully."  else    
echo "ERROR: Nginx config invalid." >&2    exit 1  fifi
echo ">>> Done."
